                ...
                {simSummaryMeta.pending ? (
                  ...
                  <ul className="space-y-1">
                    <li>
                      ...
                      {simSummaryAnalysis.impact.estimated_casualties ??
                        'unknown'}
                    </li>
                    <li>
                      Estimated injured:{' '}
                      {simSummaryAnalysis.impact.estimated_injured ??
                        'unknown'}
                    </li>
                    <li>
                      Damaged infrastructure:{' '}
                      {simSummaryAnalysis.impact.damaged_infrastructure ??
                        'unknown'}
                    </li>
                    <li>
                      Tsunami risk:{' '}
